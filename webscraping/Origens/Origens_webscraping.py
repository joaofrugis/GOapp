...
url = 'https://www.origensimoveis.com.br/imoveis/a-venda/leme'
pages = 2
...
for i in range(1,pages + 1):    
    ...
    for anuncio in anuncios:
        ...
        card['url_anuncio'] = 'https://www.origensimoveis.com.br' + anuncio['href']
        count += 1
        cards.append(card)

df = pd.DataFrame(cards)
df.to_csv('./Origens_data.csv', ';',index=False)